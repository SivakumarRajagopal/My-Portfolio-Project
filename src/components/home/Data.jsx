...
const Data = () => {
  return (
    <div className='home__data'>
      <h1 className="home__title">Sivakumar R
      <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
      ...
      <h3 className="home__subtitle">Fresher</h3>
      <p className="home__description">Hi there! Myself Sivakumar.I am very passionate about evergrowing technology especially in the field of Software Industry and DataScience...
       </p>
